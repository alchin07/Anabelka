...
<head>
    ...
    <link rel="stylesheet" href="/Anabelka/css/admin-system-error-external-notifications.css?v=1">
</head>
<body>
    ...
    <section class="error-alert-settings-head">
        <div>
            ...
            <p>
                ...
                Самі транспортні підключення Email і Telegram будемо підключати окремо.
            </p>
        </div>
    ...
    >
        ...
        <section class="error-alert-card is-master">
            <div class="error-alert-card-copy">
                ...
                <p>Головний перемикач. Якщо вимкнено — жодне зовнішнє повідомлення не буде відправлятися.</p>
            </div>
        ...
        <section class="error-alert-card">
            <div class="error-alert-section-title">
                <h3>Канали</h3>
                <p>На цьому кроці зберігаємо політику та адресатів. Секретні ключі каналів у базу не записуються.</p>
            </div>
            ...
            <div class="error-alert-security-note">
                Токен Telegram-бота, SMTP-пароль та інші секрети тут не зберігаються. Для них буде локальний файл конфігурації, який не потрапляє в GitHub.
            </div>
        </section>
