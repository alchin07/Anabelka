...
$collectionPath = (string) ($collectionPath ?? '/Anabelka/discounts');
    ...
    <section class="storefront-page-shell" aria-labelledby="storefront-page-title">
        <header class="storefront-page-head">
            ...
            <p>
                <?= $escape(
                    Translator::t(
                        'storefront.discounts.intro',
                        'Товари Анабельки з актуальними знижками.'
                    )
                ) ?>
            </p>
        </header>
        ...
        <?php if (empty($collection['items'])): ?>
            <div class="storefront-empty">
                <?= $escape(
                    Translator::t(
                        'storefront.discounts.empty',
                        'Товарів зі знижкою поки немає.'
                    )
                ) ?>
            </div>
        <?php else: ?>
