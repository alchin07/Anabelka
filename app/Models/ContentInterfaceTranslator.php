    ...
    public static function seed()
    {
        ...
        $translations = [
            'uk' => [
                ...
                'storefront.new.intro' => 'Найновіші товари Анабельки без знижок і без розділів 18+.',
                ...
                'storefront.delivery_payment.title' => 'Доставка, оплата і повернення',
                'storefront.delivery_payment.intro' => 'Інформація про умови покупки в одному місці.',
                'storefront.delivery_payment.delivery' => 'Доставка',
                'storefront.delivery_payment.payment' => 'Оплата',
                'storefront.delivery_payment.returns' => 'Повернення',
                'storefront.info.pending' => 'Інформація уточнюється.',
                'storefront.contacts.title' => 'Контакти',
                'storefront.contacts.intro' => 'Контактна інформація магазину.',
                'storefront.contacts.details' => 'Зв’язок з Анабелькою',
                'storefront.contacts.pending' => 'Контактні дані ще не опубліковані.'
            ],
            'ru' => [
                'news.title' => 'Новости',
                ...
                'storefront.new.title' => 'Новинки',
                'storefront.new.intro' => 'Самые новые товары Анабельки без скидок и без разделов 18+.',
                ...
                'storefront.delivery_payment.title' => 'Доставка, оплата и возврат',
                'storefront.delivery_payment.intro' => 'Информация об условиях покупки в одном месте.',
                'storefront.delivery_payment.delivery' => 'Доставка',
                'storefront.delivery_payment.payment' => 'Оплата',
                'storefront.delivery_payment.returns' => 'Возврат',
                'storefront.info.pending' => 'Информация уточняется.',
                'storefront.contacts.title' => 'Контакты',
                'storefront.contacts.intro' => 'Контактная информация магазина.',
                'storefront.contacts.details' => 'Связь с Анабелькой',
                'storefront.contacts.pending' => 'Контактные данные ещё не опубликованы.'
            ],
            'en' => [
                'news.title' => 'News',
                ...
                'storefront.new.intro' => 'The newest Anabelka products without discounts and excluding 18+ sections.',
                ...
                'storefront.delivery_payment.title' => 'Delivery, payment and returns',
                'storefront.delivery_payment.intro' => 'Purchase information in one place.',
                'storefront.delivery_payment.delivery' => 'Delivery',
                'storefront.delivery_payment.payment' => 'Payment',
                'storefront.delivery_payment.returns' => 'Returns',
                'storefront.info.pending' => 'Information is being confirmed.',
                'storefront.contacts.title' => 'Contacts',
                'storefront.contacts.intro' => 'Store contact information.',
                'storefront.contacts.details' => 'Contact Anabelka',
                'storefront.contacts.pending' => 'Contact details have not been published yet.'
            ]
        ];
