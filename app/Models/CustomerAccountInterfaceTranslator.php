    ...
    public static function seed()
    {
        ...
        $translations = [
            'uk' => [
                ...
                'public.account.adult_settings' => 'Вік і товари 18+',
                'public.account.adult_settings_hint' => 'Дата народження використовується для перевірки повноліття. Товари 18+ з’являються у звичайному пошуку лише після вашого дозволу.',
                'public.account.birth_date' => 'Дата народження',
                'public.account.show_adult' => 'Показувати товари 18+',
                'public.account.show_adult_hint' => 'Доступно лише користувачам, яким виповнилося 18 років.',
                'public.account.adult_save' => 'Зберегти налаштування 18+',
                'public.account.adult_saved' => 'Налаштування віку та 18+ збережено.',
                'public.account.adult_enabled' => '18+ увімкнено',
                'public.account.adult_disabled' => '18+ вимкнено',
            ...
            'ru' => [
                ...
                'public.account.adult_settings' => 'Возраст и товары 18+',
                'public.account.adult_settings_hint' => 'Дата рождения используется для проверки совершеннолетия. Товары 18+ появляются в обычном поиске только после вашего разрешения.',
                'public.account.birth_date' => 'Дата рождения',
                'public.account.show_adult' => 'Показывать товары 18+',
                'public.account.show_adult_hint' => 'Доступно только пользователям, которым исполнилось 18 лет.',
                'public.account.adult_save' => 'Сохранить настройки 18+',
                'public.account.adult_saved' => 'Настройки возраста и 18+ сохранены.',
                'public.account.adult_enabled' => '18+ включено',
                'public.account.adult_disabled' => '18+ выключено',
            ...
            'en' => [
                ...
                'public.account.adult_settings' => 'Age and 18+ products',
                'public.account.adult_settings_hint' => 'Your birth date is used to check adult eligibility. 18+ products appear in normal search only after you allow them.',
                'public.account.birth_date' => 'Date of birth',
                'public.account.show_adult' => 'Show 18+ products',
                'public.account.show_adult_hint' => 'Available only to users aged 18 or older.',
                'public.account.adult_save' => 'Save 18+ settings',
                'public.account.adult_saved' => 'Age and 18+ settings saved.',
                'public.account.adult_enabled' => '18+ enabled',
                'public.account.adult_disabled' => '18+ disabled',
