    ...
    public static function seed()
    {
        ...
        $translations = [
            'uk' => [
                ...
                'public.account.adult_privacy_hint' => 'Дата народження не є обов’язковою. Для доступу до розділу 18+ достатньо підтвердити повноліття.',
                'public.account.birth_optional' => 'Необов’язково. Ви можете залишити це поле порожнім.',
                'public.account.adult_confirm' => 'Мені вже виповнилося 18 років',
                'public.account.adult_confirm_hint' => 'Підтвердження відкриває доступ до окремого розділу 18+ без обов’язкового збереження дати народження.',
                'public.account.adult_search' => 'Показувати товари 18+ у звичайному пошуку',
                'public.account.adult_search_hint' => 'Увімкніть лише якщо хочете бачити 18+ товари разом зі звичайними результатами пошуку.',
                'public.account.adult_status_rank' => '18+ доступ за рангом',
                'public.account.adult_status_confirmed' => '18+ підтверджено',
                'public.account.adult_status_off' => '18+ не підтверджено',
                'public.account.adult_status_blocked' => '18+ недоступно',
                'public.account.adult_vip_hint' => 'Ваш ранг дає автоматичний доступ до розділу 18+. Дата народження та окреме підтвердження не потрібні.',
                'public.account.adult_preferences_saved' => 'Налаштування 18+ збережено.',
            ...
            'ru' => [
                ...
                'public.account.adult_privacy_hint' => 'Дата рождения не обязательна. Для доступа к разделу 18+ достаточно подтвердить совершеннолетие.',
                'public.account.birth_optional' => 'Необязательно. Это поле можно оставить пустым.',
                'public.account.adult_confirm' => 'Мне уже исполнилось 18 лет',
                'public.account.adult_confirm_hint' => 'Подтверждение открывает доступ к отдельному разделу 18+ без обязательного сохранения даты рождения.',
                'public.account.adult_search' => 'Показывать товары 18+ в обычном поиске',
                'public.account.adult_search_hint' => 'Включайте только если хотите видеть товары 18+ вместе с обычными результатами поиска.',
                'public.account.adult_status_rank' => '18+ доступ по рангу',
                'public.account.adult_status_confirmed' => '18+ подтверждено',
                'public.account.adult_status_off' => '18+ не подтверждено',
                'public.account.adult_status_blocked' => '18+ недоступно',
                'public.account.adult_vip_hint' => 'Ваш ранг даёт автоматический доступ к разделу 18+. Дата рождения и отдельное подтверждение не требуются.',
                'public.account.adult_preferences_saved' => 'Настройки 18+ сохранены.',
            ...
            'en' => [
                ...
                'public.account.adult_privacy_hint' => 'Your date of birth is optional. Confirming that you are 18 or older is enough to access the 18+ section.',
                'public.account.birth_optional' => 'Optional. You can leave this field blank.',
                'public.account.adult_confirm' => 'I am 18 or older',
                'public.account.adult_confirm_hint' => 'Confirmation opens the separate 18+ section without requiring your date of birth to be stored.',
                'public.account.adult_search' => 'Show 18+ products in normal search',
                'public.account.adult_search_hint' => 'Enable this only if you want 18+ products mixed with normal search results.',
                'public.account.adult_status_rank' => '18+ access by rank',
                'public.account.adult_status_confirmed' => '18+ confirmed',
                'public.account.adult_status_off' => '18+ not confirmed',
                'public.account.adult_status_blocked' => '18+ unavailable',
                'public.account.adult_vip_hint' => 'Your rank grants automatic access to the 18+ section. A birth date and separate confirmation are not required.',
                'public.account.adult_preferences_saved' => '18+ settings saved.',
