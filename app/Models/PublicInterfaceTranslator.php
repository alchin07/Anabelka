    ...
    public static function seed()
    {
        ...
        $translations = [
            'uk' => [
                ...
                'public.catalog.adult_enter' => 'Увійти до розділу',
                ...
                'public.order.items' => 'Товари',
                'public.order.size' => 'Розмір',
                'public.order.color' => 'Колір',
                'public.order.pieces' => 'шт.',
                'public.order.history_title' => 'Мої замовлення',
                'public.order.history_text' => 'Тут зберігаються ваші звичайні та швидкі замовлення.',
                'public.order.history_empty' => 'У вас ще немає замовлень.',
                'public.order.status_new' => 'Нове',
                'public.order.status_processing' => 'В обробці',
                'public.order.status_completed' => 'Завершене',
                'public.order.status_cancelled' => 'Скасоване',
                'public.order.quick_order' => 'Швидке замовлення',
                'public.order.regular_order' => 'Замовлення',
                'public.order.show_items' => 'Показати товари',
            ...
            'ru' => [
                ...
                'public.catalog.adult_enter' => 'Войти в раздел',
                ...
                'public.order.items' => 'Товары',
                'public.order.size' => 'Размер',
                'public.order.color' => 'Цвет',
                'public.order.pieces' => 'шт.',
                'public.order.history_title' => 'Мои заказы',
                'public.order.history_text' => 'Здесь сохраняются ваши обычные и быстрые заказы.',
                'public.order.history_empty' => 'У вас ещё нет заказов.',
                'public.order.status_new' => 'Новый',
                'public.order.status_processing' => 'В обработке',
                'public.order.status_completed' => 'Завершён',
                'public.order.status_cancelled' => 'Отменён',
                'public.order.quick_order' => 'Быстрый заказ',
                'public.order.regular_order' => 'Заказ',
                'public.order.show_items' => 'Показать товары',
            ...
            'en' => [
                ...
                'public.catalog.adult_enter' => 'Enter section',
                ...
                'public.order.color' => 'Color',
                'public.order.pieces' => 'pcs.',
                'public.order.history_title' => 'My orders',
                'public.order.history_text' => 'Your regular and quick orders are saved here.',
                'public.order.history_empty' => 'You do not have any orders yet.',
                'public.order.status_new' => 'New',
                'public.order.status_processing' => 'Processing',
                'public.order.status_completed' => 'Completed',
                'public.order.status_cancelled' => 'Cancelled',
                'public.order.quick_order' => 'Quick order',
                'public.order.regular_order' => 'Order',
                'public.order.show_items' => 'Show items',
